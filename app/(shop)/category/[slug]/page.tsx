    ...
    <main className="animate-fade-in min-h-[70vh]">
      ...
      <div className="mx-auto max-w-6xl px-4 py-4">
        <nav className="flex items-center gap-1.5 text-xs text-slate-400">
          ...
          <ChevronRight size={12} />
          <span className="text-slate-600 font-medium">{categoryTitle}</span>
        </nav>
      </div>
      ...
      <section className="mx-auto max-w-6xl px-4 pb-20">
        {!finalProducts || finalProducts.length === 0 ? (
          <div className="card p-16 text-center">
            ...
            <p className="font-semibold text-slate-800 mb-1">No products found in &ldquo;{categoryTitle}&rdquo;</p>
                ...
                >
                  ...
                  <div className="p-3 sm:p-4 bg-white border-t border-slate-100 flex justify-between items-start gap-2">
                    <div className="min-w-0">
                      ...
                      <p className="mt-0.5 text-xs text-slate-400 capitalize">{categoryTitle}</p>
                    </div>
